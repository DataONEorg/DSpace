...
public class OREManifestWriter {
    ...
    protected String retrieveEncodedIdentifier(Bitstream b)
    {
        return retrieveEncodedIdentifier(String.valueOf(b.getID()));
    }

    protected String retrieveEncodedIdentifier(String id)
    {
        try {
            return URLEncoder.encode(retrieveIdentifier(id), "UTF-8");
        } catch (UnsupportedEncodingException e) {
            return URLEncoder.encode(retrieveIdentifier(id));
        }
    }
    ...
    public Bitstream updateORE(Context c, Item newItem, Version version, boolean b) throws NoSuchAlgorithmException, SQLException, IOException {
        ...
        Resource aggregation = model.createResource("https://cn.dataone.org/cn/v1/resolve/" + this.retrieveEncodedIdentifier(String.valueOf(id)) + "#aggregation")
                .addProperty(RDF.type, ORE.Aggregation)
                .addProperty(DCTerms.title, newItem.getMetadata("dc.title")[0].value);

        Resource rem = model.createResource("https://cn.dataone.org/cn/v1/resolve/" + this.retrieveEncodedIdentifier(String.valueOf(id)))
                ...
                .addProperty(DCTerms.identifier, this.retrieveIdentifier(String.valueOf(id)))
        ...
        Resource scimeta = model.createResource("https://cn.dataone.org/cn/v1/resolve/" + this.retrieveEncodedIdentifier(mets))
        ...
        for(Bundle bundle : newItem.getBundles())
        {
            ...
            {
                Resource scidata = model.createResource("https://cn.dataone.org/cn/v1/resolve/" + this.retrieveEncodedIdentifier(bits));
